\hypertarget{class_lavadora}{\section{Referència de la Classe Lavadora}
...
Definició a la línia 20 del fitxer Lavadora.\+hh.
...
Se ejecuta automáticamente al declarar una lavadora. \begin{DoxyPrecond}{Precondició}
{\itshape cierto} 
\end{DoxyPrecond}
...
Representa que se realiza el lavado, se retiran la prendas que contiene la lavadora y ésta queda en estado de volver a usarse \begin{DoxyPrecond}{Precondició}
