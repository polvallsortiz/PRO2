...
void intercanviar_posicions_vector_int(vector<int>& v, int x, int y);
/*Pre: x i y són dos posicions vàlides dins el vector v dins de [0,...,n-1] */
/* Post: s'han intercanviat les dos posicions en el vector */
